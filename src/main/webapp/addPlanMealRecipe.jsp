                ...
                <div class="schedules-content">
                    <form action="/app/recipe/plan/add" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="nameMeal" type="text" class="form-control" value="" id="name" placeholder="Nazwa posiłku">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input name="numberMeal" type="number" class="form-control" value="" id="number" placeholder="Numer posiłku">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" id="day">
                                    <c:forEach items="${dayNames}" var="dayName">
                                        <option value="${dayName.name}"></option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
