                ...
                <div class="schedules-content">
                    <table class="table border-bottom">
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap"><a href="/app/plan/delete?id=${list.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
